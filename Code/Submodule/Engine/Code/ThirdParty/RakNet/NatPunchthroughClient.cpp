 ...
 */
 ...
 /*
  * Ben: Adding Warning Disables using PUSH and POP to hide warnings
  * generated by RakNet code that I do not want to modify.
  * 1/3/2020
 */
...
void TestModeToString(NatPunchthroughClient::SendPing::TestMode tm, std::string& string)
{
	string = "";
